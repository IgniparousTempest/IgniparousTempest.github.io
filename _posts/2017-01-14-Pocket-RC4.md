...
<form>
	...
	<div>
		<input style="float: left;" type="button" class="button alt" value="Encrypt Message" onclick="encrypt_on_click();"/>
		<input style="float: left;" type="button" class="button alt" value="Decrypt Message" onclick="decrypt_on_click();"/></li>
		<input style="float: right;" type="button" class="button" value="Load Example" onclick="load_example_on_click();"/>
	</div>
</form>
