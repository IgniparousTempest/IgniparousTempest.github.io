    ...
    define("Camera", ["require", "exports", "utils/Raycaster"], function (require, exports, Raycaster_1) {
        ...
        class Camera {
            constructor() {
                ...
                getImage('/images/2022-08-30-raycast-renderer/wall.png').then(value => this.textures.wall1 = value);
                getImage('/images/2022-08-30-raycast-renderer/wall2.png').then(value => this.textures.wall2 = value);
            }
